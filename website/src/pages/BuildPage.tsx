    ...
    <PageShell eyebrow={content.eyebrow} title={content.title} text={content.text}>
      <div className="grid gap-6 md:grid-cols-2">
        {content.items.map((item) => (
          <motion.div key={item.title} {...cardMotion} className="operator-surface border border-[#202224] bg-black/50 p-9 transition duration-500 hover:-translate-y-1 hover:border-[#7d6a45]/45 hover:bg-black/70">

...
export function BuildPage({ content, goToPage }: BuildPageProps) {
  return (
    <PageShell eyebrow={content.eyebrow} title={content.title} text={content.text}>
      ...
      <div className="mt-32">
        ...
        <div className="mt-10 grid gap-7 lg:grid-cols-3">
          {content.phases.map((phase) => (
            <motion.div key={phase.step} {...cardMotion} className="operator-surface border border-[#202224] bg-[#030201] p-7 md:p-8">
      ...
      <div className="mt-32 grid gap-8 lg:grid-cols-3">

  ...
  return (
    <PageShell eyebrow={content.eyebrow} title={content.title} text={content.text}>
      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="operator-surface border border-amber-300/20 bg-stone-950/70 text-stone-100 transition duration-500 hover:border-amber-300/35 hover:shadow-[0_0_55px_rgba(251,191,36,0.08)]">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {content.beforeApply.items.map((item, index) => (
              <motion.div key={item.title} {...cardMotion} className="border border-amber-300/15 bg-black/45 p-6">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <form onSubmit={submitAccessRequest} className="grid gap-5" aria-describedby={hasSubmitError ? "access-form-error" : undefined} noValidate>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="border border-stone-800 bg-stone-950/60 p-5 transition focus-within:border-amber-300/35">
            ...
            <div className="border border-stone-800 bg-stone-950/60 p-4 md:p-5">
            ...
            <div className="border border-stone-800 bg-stone-950/60 p-5 transition focus-within:border-amber-300/35">
              ...
              <textarea id="access-message" name="message" value={form.message} onChange={(event) => setForm((current) => ({ ...current, message: event.target.value }))} placeholder={content.form.messagePlaceholder} maxLength={2000} className="mt-4 min-h-28 w-full resize-none border border-stone-900 bg-black/30 p-4 text-stone-200 outline-none placeholder:text-stone-700" />
            </div>

            <div className="border border-amber-300/15 bg-black/35 p-5" aria-live="polite">

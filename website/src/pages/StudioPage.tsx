  ...
  return (
    <PageShell eyebrow={content.eyebrow} title={content.title} text={content.text}>
      <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        <motion.div {...cardMotion} className="relative overflow-hidden border border-[#202224] bg-[#030201] p-8 md:p-10 md:backdrop-blur-xl">
      ...
      <div className="mt-32 grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-stretch">
        <div className="border-y border-[#7d6a45]/40 bg-[#030201]/65 px-6 py-8 md:px-8">
        ...
        <div className="relative overflow-hidden border border-[#202224] bg-[#030201] p-7 md:p-10">
      ...
      <div className="mt-32 border border-[#202224] bg-[#030201] p-7 md:p-12">
      ...
      <div className="mt-32 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative overflow-hidden border border-[#202224] bg-[#030201] p-7 md:p-12">
          <div className="pointer-events-none absolute inset-0 veil-lines opacity-20" aria-hidden="true" />
          <div className="relative">
        ...
        <div className="border border-red-300/15 bg-[#030201] p-7 md:p-10">
      ...
      <div className="mt-32 grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-none border border-[#202224] bg-[#030201] p-8 md:p-10">
        ...
        <div className="border border-[#202224] bg-[#030201] p-6 md:p-10">

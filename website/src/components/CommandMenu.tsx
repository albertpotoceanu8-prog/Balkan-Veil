      ...
      >
        <div className="flex items-center justify-between border-b border-stone-800 px-6 py-5">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-amber-300/25 bg-amber-300/5 text-amber-200">
                <Command className="h-5 w-5" />
              </div>
              <div>
                <p className="font-serif text-2xl text-amber-100">{labels.title}</p>
                <p className="text-xs uppercase tracking-[0.28em] text-stone-500">{labels.subtitle}</p>
              </div>
          </div>
          <button onClick={close} className="rounded-full border border-stone-800 p-2 text-stone-400 transition hover:text-amber-200">
            <X className="h-5 w-5" />
          </button>
        </div>

...
export function ArchiveStamp({ code, label, status, align = "left", className = "" }: ArchiveStampProps) {
  return (
    <div className={`inline-flex max-w-full flex-col gap-2 border border-[#252729] bg-black/45 px-5 py-4 text-xs uppercase tracking-[0.24em] text-[#c8ad72] ${align === "right" ? "items-end text-right" : "items-start"} ${className}`}>

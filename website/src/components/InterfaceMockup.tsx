...
export function InterfaceMockup({ eyebrow, title, text, systemLabel, statusLine, moduleLabel, metrics, rows }: InterfaceMockupProps) {
  return (
    <section className="relative z-10 grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
      <div>
      ...
      <motion.div {...cardMotion} className="veil-frame operator-surface relative overflow-hidden border border-[#252729] bg-black/70 p-5 md:p-8 md:backdrop-blur-xl">
        ...
        <div className="relative border border-[#202224] bg-[#050302]/92">
          <div className="flex flex-col gap-4 border-b border-[#202224] px-5 py-5 sm:flex-row sm:items-center sm:justify-between md:px-6">
          ...
          <div className="grid gap-0 md:grid-cols-[0.85fr_1.15fr]">
            <div className="border-b border-[#202224] p-5 md:border-b-0 md:border-r md:p-8">
            ...
            <div className="p-5 md:p-8">
              ...
              <div className="mt-7 divide-y divide-[#202224]">
                {rows.map((row, index) => (
                  <div key={row} className="grid grid-cols-[2.25rem_1fr_auto] items-center gap-4 py-5 md:grid-cols-[3rem_1fr_auto] md:gap-5">
